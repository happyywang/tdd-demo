...
const TDDPresentation = () => {
  ...
  const TitleSlide = () => (
    <div className="flex flex-col items-center justify-center text-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" style={{minHeight: LAYOUT.SLIDE_MIN_HEIGHT}}>
      ...
      {/* Presenter Name with Company Logo */}
      <div className="flex items-center mt-4">
        <p className="text-2xl text-gray-300">Yan Wang</p>
        <span className="text-2xl text-gray-500 ml-4 mr-2">|</span>
        <img
  ...
  const DisadvantagesSlide = () => {
    ...
    const challenges = [
      ...
      },
      {
        ...
        detail: "Many tests are still written in a unit test style, focusing on verifying internal logic or code paths.",
